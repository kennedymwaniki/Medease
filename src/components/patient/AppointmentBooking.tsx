...
const AppointmentBooking = () => {
  ...
  const StepIndicator = ({
    ...
    <div
      className={`flex items-center ${step < stepNumber ? 'text-blue-500' : step === stepNumber ? 'text-blue-600' : 'text-gray-400'}`}
    >
      <div
      ...
      <div className="bg-white rounded-lg border border-gray-200 p-6">
        ...
        <div className="space-y-4">
          ...
          <form.Field
            ...
            validators={{
              onChange: ({ value }) =>
                validateField(value, appointmentSchema.shape.location),
              onBlur: ({ value }) =>
                validateField(value, appointmentSchema.shape.location),
            }}
            children={(field) => (
              <div>
                ...
                >
                  ...
                  <option value="Clinic Room 1">Clinic Room 1</option>
                  <option value="Clinic Room 2">Clinic Room 2</option>
          ...
          <div className="flex items-center space-x-8">
            {steps.map((step, index) => (
              <div key={step.number} className="flex items-center space-x-2">
                ...
                <span
                  className={`text-sm ${currentStep >= step.number ? 'text-gray-900' : 'text-gray-500'}`}
                >
                  {step.title}
                </span>
